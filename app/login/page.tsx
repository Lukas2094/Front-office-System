...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
            ...
            <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-white px-8 py-12 md:px-16 shadow-2xl relative z-10"> <h2 className="text-4xl font-extrabold text-gray-800 mb-2">
            Bem-vindo! </h2> <p className="text-gray-500 mb-10 text-center">
            Acesse o sistema da <span className="text-yellow-500 font-semibold">OficinaTech</span> </p>
