...
const menuItems = [
    { icon: FiHome, label: 'Dashboard', href: '/dashboard', color: 'text-blue-400' },
    { icon: FiUsers, label: 'Clientes', href: '/clientes', color: 'text-green-400' },
    { icon: FiTruck, label: 'Veículos', href: '/veiculos', color: 'text-purple-400' },
    { icon: FiFileText, label: 'Ordens Serviço', href: '/ordens-servico', color: 'text-orange-400' },
    // { icon: FiDollarSign, label: 'Financeiro', href: '/financeiro', color: 'text-emerald-400' },
    // { icon: FiPackage, label: 'Estoque', href: '/estoque', color: 'text-red-400' },
    { icon: FiCalendar, label: 'Agendamentos', href: '/agendamentos', color: 'text-pink-400' },
    { icon: FiUsers, label: 'Usuários', href: '/usuarios', color: 'text-cyan-400' },
    // { icon: FiSettings, label: 'Configurações', href: '/configuracoes', color: 'text-gray-300' },
];
      ...
      `}</style>
            ...
            `}
              ...
              `}
                ...
                {/* Footer */}
                <div
                    className={`p-4 border-t border-gray-700 ${isSidebarExpanded ? '' : 'text-center'
                        }`}
                >
                    {isSidebarExpanded ? (
                        <div className="text-sm text-gray-400">
                            <div className="font-medium text-gray-300">Sistema Oficina</div>
                            <div>v1.0.0</div>
                        </div>
                    ) : (
